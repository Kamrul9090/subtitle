        ...
        <div>
            ...
            <div className="flex items-center justify-between bg-darkWhite p-2 text-xs lg:text-lg">
                <div className="flex items-center space-x-1">
                    ...
                    <p className="">Kamrul_9090</p>
                </div>
                <div>
                    <ul className="flex space-x-2 lg:space-x-4">
                        <Link href=""><li className="hover:text-secondary">Logout</li></Link>
                        <span>|</span>
            ...
            <section>
                <div className="flex flex-col lg:flex-row items-center py-4">
                    ...
                    <div className="w-full lg:w-1/5 text-center">
                        <Link href=""><u className="text-secondary hover:text-primary text-xs lg:text-lg" title="upload your subtitle">Upload Subtitle</u></Link>
                    </div>
                </div>
            </section>
            <hr />
